const socialLinks = [
  {
    href: "https://github.com/avoloder9",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/adnan-voloder-98a0b3276/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/adnan.voloder9/",
    icon: (
      <svg
        width="25"
        height="24"
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col ">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[40ch]">
            Feel free to get in touch if you want to connect or discuss any
            opportunities. I’m eager to learn and contribute!
          </p>
        ...
        <form
          action="https://getform.io/f/bpjpveob"
          method="POST"
        ...
        >
          ...
          <button
            type="submit"
            className="w-full justify-center btn btn-primary !max-w-full"
          >
            Submit
          </button>
        </form>
